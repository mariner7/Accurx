...
const createAppointmentUseCase = new CreateAppointmentUseCase(appointmentRepo, patientRepo, doctorRepo, policyService);
...
const rescheduleAppointmentUseCase = new RescheduleAppointmentUseCase(appointmentRepo, policyService);
...
export class AppointmentController {
    ...
    async confirm(req, res, next) {
        try {
            const { id } = appointmentIdSchema.parse(req.params);
            const actorType = req.body.actorType || ActorType.DOCTOR;
    ...
    async cancel(req, res, next) {
        try {
            const { id } = appointmentIdSchema.parse(req.params);
            const actorType = req.body.actorType || ActorType.PATIENT;
